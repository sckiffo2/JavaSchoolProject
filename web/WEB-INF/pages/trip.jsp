                            ...
                            <div class="card-body">
                                <form method="POST" action="trip\add" class="form-horizontal">
                                    <div class="form-group row">
                                        <h6>Добавление нового рейса</h6>
                                    </div>
                                    <div class="form-group row">
                                        <label for="routes">Маршрут</label>
                                        <div class="col-sm-10">
                                                    ...
                                                    <table id="table" class="table table-striped table-sm">
                                                        ...
                                                        <c:forEach var="trip" items="${trips}">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <c:choose>
                                                                        <c:when test="${trip.canceled}">Отменен</c:when>
                                                                        <c:otherwise>Активен</c:otherwise>
                                                                    </c:choose>
                                                                </td>
                                                                <td>
                                                                    <c:out value="${trip.delay}"/>
                                                                </td>
                                                                <td>
                                                                    <a href="trip\edit\<c:url value="${trip.getId()}"/>">Изменить</a>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                                    </table>
