...
<%@ page contentType="text/html;charset=UTF-8"%>
    ...
    <c:set var="title" value="Редактирование ролей пользователя" />
            ...
            <div class="breadcrumb-holder">
                <div class="container-fluid">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Редактирование ролей пользователя</li>
                    </ul>
                </div>
            </div>
            <section class="forms">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <h4>Редактирование ролей пользователя</h4>
                                </div>
                                <div class="card-body">
                                    <h1>Извините, данная страница находится в разработке.</h1>
<%--                                    <form method="POST" action="updateUserRole" class="form-horizontal">--%>
